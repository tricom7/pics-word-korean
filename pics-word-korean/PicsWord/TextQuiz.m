...
@synthesize textArray_ENG, textArray_KOR, textArray_Phonetic;
...
//    }
    ...
    textArray_KOR = [[NSMutableArray alloc] init];
    ...
    for (int i=0; i<[WORD_ENG count]; i++) {
        ...
        NSString *quizChar_ENG = [WORD_ENG objectAtIndex:randomNum]; 
        NSString *quizChar_KOR = [WORD_KOR objectAtIndex:randomNum]; 
        NSString *quizPhonetic = [WORD_KOR_PRO objectAtIndex:randomNum];

        [textArray_ENG addObject:quizChar_ENG];
        [textArray_KOR addObject:quizChar_KOR];
...
- (IBAction) button1Clicked:(id)sender {
	...
	if (ordinal==-1) {
		...
		if (dabNo == 1) {
			...
			[[self appDelegate] soundPlay:@"nice.aif"];
			...
			[[self appDelegate] soundPlay:@"beep_3.aif"];
...
- (IBAction)soundClicked:(id)sender {
    ...
    //발음
    if ([[self appDelegate].lang isEqualToString:@"ENG"]) {
        audioName_ENG = [NSString stringWithFormat:@"ENG_%@.mp3", [WORD_ENG objectAtIndex:ordinal]]; 
        
    } else if ([[self appDelegate].lang isEqualToString:@"CHA"]) {
        audioName_ENG = [NSString stringWithFormat:@"CHA_%@.mp3", [WORD_ENG objectAtIndex:ordinal]]; 
        
    } else if ([[self appDelegate].lang isEqualToString:@"JPN"]) {
        audioName_ENG = [NSString stringWithFormat:@"JPN_%@.mp3", [WORD_ENG objectAtIndex:ordinal]]; 
        
    } else if ([[self appDelegate].lang isEqualToString:@"KOR"]) {
        audioName_ENG = [NSString stringWithFormat:@"KOR_%@.mp3", [WORD_ENG objectAtIndex:ordinal]]; 
...
- (void) nextQuiz {
	...
	currentNumber.text = [NSString stringWithFormat:@"Quiz #%d/%d",ordinal+1,[textArray_ENG count]];
...
//    audioName_ENG = [NSString stringWithFormat:@"%@.mp3", [textArray_ENG objectAtIndex:ordinal]];    
    ...
    if (!isEnd) {
        ...
        [[self appDelegate] soundPlay:audioName_ENG];
//        if ([self appDelegate].isPhoneticSymbolOnQuiz==1) {
